...
bool UMathLibrary::CheckIsInFront(FVector const& Point, FVector const& PortalLocation,
...
bool UMathLibrary::CheckIsCrossing(FVector const& Point, FVector const& PortalLocation,
...
bool UMathLibrary::IsPointInsideBox(FVector Point, UBoxComponent* Box)
{
	if( Box != nullptr )
	{
